bowtie2 -p 1 --qc-filter --local --very-sensitive-local -x /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.genome -1 F2_S1_L001_R1_001.fastq -2 F2_S1_L001_R2_001.fastq | samtools view -u -q 10 -@ 1 - | samtools sort -n -@ 1 -o - temp1 | samtools fixmate -r - - | samtools sort -o - temp5 | samtools mpileup -puD -f /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.dna.toplevel.fa - | bcftools call -O b -m -S snps - > F2_S1_L001.indels.bcf.gz &
bowtie2 -p 1 --qc-filter --local --very-sensitive-local -x /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.genome -1 F3_S2_L001_R1_001.fastq -2 F3_S2_L001_R2_001.fastq | samtools view -u -q 10 -@ 1 - | samtools sort -n -@ 1 -o - temp2 | samtools fixmate -r - - | samtools sort -o - temp6 | samtools mpileup -puD -f /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.dna.toplevel.fa - | bcftools call -O b -m -S snps - > F3_S2_L001.indels.bcf.gz &
bowtie2 -p 5 --qc-filter --local --very-sensitive-local -x /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.genome -1 FM7_S3_L001_R1_001.fastq -2 FM7_S3_L001_R2_001.fastq | samtools view -u -q 10 -@ 1 - | samtools sort -n -@ 1 -o - temp3 | samtools fixmate -r - - | samtools sort -o - temp7 | samtools mpileup -puD -f /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.dna.toplevel.fa - | bcftools call -O b -m -S snps - > FM7_S3_L001.indels.bcf.gz &
bowtie2 -p 1 --qc-filter --local --very-sensitive-local -x /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.genome -1 OreR_S4_L001_R1_001.fastq -2 OreR_S4_L001_R2_001.fastq | samtools view -u -q 10 -@ 1 - | samtools sort -n -@ 1 -o - temp4 | samtools fixmate -r - - | samtools sort -o - temp8 | samtools mpileup -puD -f /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.dna.toplevel.fa - | bcftools call -O b -m -S snps - > OreR_S4_L001.indels.bcf.gz &
bowtie2 -p 8 --qc-filter --local --very-sensitive-local -x /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.genome -1 F5_S1_L001_R1_001.fastq -2 F5_S1_L001_R2_001.fastq | samtools view -u -q 10 -@ 1 - | samtools sort -n -@ 1 -o - temp10 | samtools fixmate -r - - | samtools sort -o - temp9 | samtools mpileup -puD -f /Volumes/IMAGES/databasefiles/Drosophila_melanogaster.BDGP5.73/Drosophila_melanogaster.BDGP5.74.dna.toplevel.fa - | bcftools call -O b -m -S snps - > F5_S1_L001.indels.bcf.gz ;
