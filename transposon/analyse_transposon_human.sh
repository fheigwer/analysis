...
bowtie2 -p 8 -x Homo_sapiens.GRCh37.73.genome -1 $1_5_R1.fastq -2 $1_5_R2.fastq -U $1_5_U.fastq -S $1_5prime.sam 
bowtie2 -p 8 -x Homo_sapiens.GRCh37.73.genome -1 $1_3_R1.fastq -2 $1_3_R2.fastq -U $1_3_U.fastq  -S $1_3prime.sam
