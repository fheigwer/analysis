...
# load data  G3
POSITIVE <- read.table("/Users/b110-mm06/Desktop/Projects/IPS_kinome_data/singlecell/sample_well_data_131204/10301_G03/DefaultOUT_Nuclei.csv",sep="\t",dec=".",header=TRUE)
POSITIVE<-POSITIVE[(which(!is.na(rowMeans(POSITIVE)))),]
NEGATIVE <- read.table("/Users/b110-mm06/Desktop/Projects/IPS_kinome_data/singlecell/sample_well_data_131204/10301_G04/DefaultOUT_Nuclei.csv",sep="\t",dec=".",header=TRUE)
NEGATIVE<-NEGATIVE[(which(!is.na(rowMeans(NEGATIVE)))),]
SAMPLE <- read.table("/Users/b110-mm06/Desktop/Projects/IPS_kinome_data/singlecell/sample_well_data_131204/10303_A07/DefaultOUT_Nuclei.csv",sep="\t",dec=".",header=TRUE)
...
SAMPLE.levels=knn(TRAINDATA, SAMPLE, TRAINED_CLUST$cluster, k = 100, prob=TRUE) 


plot(density(as.numeric(TRAINED_CLUST$cluster)),ylim=c(0,1),col="green")
