...
sample=paste("/home/mount/fheigwer/ips_kinome_screen/data/Christian_IPSC/",i,"/DefaultOUT_Nuclei_sample.tab",sep="")
...
save(sample_data,file=paste(i,"sample_data_ctrltrain_non_rand.RData"))

raw_levels=knn(raw_data, sample_data, raw_clust$cluster, k = 100, prob=F)
clustering=cbind(origin,raw_levels)
save(clustering,file=paste(i,"clustering_ctrltrain_non_rand.RData"))
